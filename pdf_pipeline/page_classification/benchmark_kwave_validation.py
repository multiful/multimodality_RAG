"""[4] 다른 섹터 PDF(K-Wave 산업 리포트, 73페이지)로 일반화 검증 — baseline vs YOLOv11n
페이지 분류를 새 PDF에 대해 실행하고 예측만 저장(정답은 샘플링 기반 육안 검수로 별도 작성).
"""
...
RESULT_PATH = OUT_DIR / "result_kwave_page_classification.json"
CROP_DIR = OUT_DIR / "table_crops_kwave"
